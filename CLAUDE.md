...
2. 按 `D:\08-stock\stock-partner-team\agents\stock-partner-lead.md` 的「结果汇编」规范，产出**圆桌报告初稿**
...
1. Read `D:\08-stock\stock-partner-team\agents\redcard-challenger.md` 获取红牌挑战者完整角色定义
...
4. 详细流程与约束见 `D:\08-stock\stock-partner-team\agents\stock-partner-lead.md` 的「红牌挑战流程」章节
